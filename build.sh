...
if [ -f "$prosody_build_dir/prosody-x86_64.AppImage" ] && [ -f "$prosody_build_dir/prosody-aarch64.AppImage" ]; then
...
mkdir -p "$prosody_destination_dir" && cp $prosody_build_dir/prosody-x86_64.AppImage "$prosody_destination_dir/"
mkdir -p "$prosody_destination_dir" && cp $prosody_build_dir/prosody-aarch64.AppImage "$prosody_destination_dir/"
